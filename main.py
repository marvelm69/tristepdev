...
# Main page showing Google Sheets data and status update
...
def main():
    ...
    pages = {
        ...
        "Google Sheets Viewer": show_main_page
    }

    # Sidebar for page selection
    selected_page = st.sidebar.selectbox("Select Page", options=pages.keys())
    ...
    if not st.session_state['logged_in'] and selected_page == "Google Sheets Viewer":
        st.warning("You need to login first!")
        show_login_page()
    else:
        if selected_page == "Google Sheets Viewer":
